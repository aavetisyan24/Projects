...
SOCKET1 = "wss://fstream.binance.com/stream?streams=ethbusd@bookTicker/ethusdt@bookTicker"
...
def fut(SOCKET):
    ...
    def on_message(ws, message):
        ...
        pprint.pprint((json_message['s'], (runtime), json_message['a'], json_message['b']))
